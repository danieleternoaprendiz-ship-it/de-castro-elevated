      ...
      >
        ...
        >
          {visible.map((c) => (
            ...
            >
              <div className="flex h-24 w-full items-center justify-center overflow-hidden rounded-md bg-white/95 p-3 shadow-[0_0_0_1px_rgba(255,255,255,0.08)]">
                {c.logo ? (
                  <img
                    src={c.logo}
                    alt={`Logo ${c.name}`}
                    loading="lazy"
                    className="max-h-[72px] w-auto max-w-full object-contain transition duration-500 group-hover:scale-105"
                  />
                ) : (

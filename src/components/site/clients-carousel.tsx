              ...
              <div className="grid h-20 w-full place-items-center">
                {c.logo ? (
                  <img
                    ...
                    alt={`Logo ${c.name}`}
                    loading="lazy"
                    className="max-h-16 w-auto max-w-[85%] object-contain opacity-70 brightness-0 invert transition duration-500 group-hover:scale-105 group-hover:opacity-100"
                  />
                ) : (
